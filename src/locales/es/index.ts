...
export const es = {
    ...
    hero: {
        ...
        description: "Proveedor profesional de desarrollo de sitios web, software a medida y aplicaciones móviles diseñadas para aumentar el valor de tu negocio digitalmente.",
    ...
    footer: {
        description: "KodingKeliling es tu socio tecnológico para soluciones digitales innovadoras.",
    ...
    faq: {
        ...
        items: [
            ...
            },
            {
                ...
                answer: "La duración depende de la complejidad del proyecto. Una página de destino simple suele tardar de 1 a 2 semanas, mientras que un sistema más complejo puede tardar de 4 à 8 semanas o más."
            },
            {
