            ...
            <div className="mx-auto max-w-container px-4 md:px-8">
                <div className="flex flex-col items-center gap-12 lg:flex-row">
                    ...
                    >
                        <motion.div 
                            variants={fadeInUp}
                            className="inline-flex items-center gap-2 rounded-full border border-brand bg-brand-primary px-3 py-1 text-sm font-semibold text-brand"
                        >
                            <span className="flex size-2 rounded-full bg-brand-solid animate-pulse" />
                            {hero.badge}
                        </motion.div>
